...
template <typename ClassRef>
jmethodID BasicJClass<ClassRef>::getMethodId(const char *const name,
...
template <typename ClassRef>
jmethodID BasicJClass<ClassRef>::getStaticMethodId(const char *const name,
                                                   const char *const sig) {
  const Context::Handle ctx = Context::getContext();
...
template <typename ClassRef>
jfieldID BasicJClass<ClassRef>::getFieldId(const char *const name,
                                           const char *const sig) {
  const Context::Handle ctx = Context::getContext();
...
template <typename ClassRef>
jfieldID BasicJClass<ClassRef>::getStaticFieldId(const char *const name,
                                                 const char *const sig) {
  const Context::Handle ctx = Context::getContext();
