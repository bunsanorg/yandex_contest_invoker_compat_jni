#include "com_yandex_contest_invoker_impl_File.h"
...
void Java_com_yandex_contest_invoker_impl_File_classInit(JNIEnv *env,
                                                         jclass fileClass) {
...
void Java_com_yandex_contest_invoker_impl_File_finalize(JNIEnv *env,
                                                        jobject self) {
...
jstring Java_com_yandex_contest_invoker_impl_File_getPath(JNIEnv *env,
                                                          jobject self) {
...
jobject Java_com_yandex_contest_invoker_impl_File_getAccessMode(JNIEnv *env,
                                                                jobject self) {
  YANDEX_JNI_METHOD_BEGIN_THIS(env, fileClass_, self)
