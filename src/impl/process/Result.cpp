...
jobject
Java_com_yandex_contest_invoker_impl_process_ProcessResult_getCompletionStatus(
    JNIEnv *env, jobject self) {
...
jobject
Java_com_yandex_contest_invoker_impl_process_ProcessResult_getExitStatus(
    JNIEnv *env, jobject self) {
  YANDEX_JNI_METHOD_BEGIN_THIS(env, processResultClass_, self)
  if (this_->exitStatus) {
...
jobject
Java_com_yandex_contest_invoker_impl_process_ProcessResult_getResourceUsage(
    JNIEnv *env, jobject self) {
  YANDEX_JNI_METHOD_BEGIN_THIS(env, processResultClass_, self)
