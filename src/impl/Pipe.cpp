...
void Java_com_yandex_contest_invoker_impl_Pipe_classInit(JNIEnv *env,
                                                         jclass pipeClass) {
...
void Java_com_yandex_contest_invoker_impl_Pipe_finalize(JNIEnv *env,
                                                        jobject self) {
...
jobject Java_com_yandex_contest_invoker_impl_Pipe_getInputStream(JNIEnv *env,
                                                                 jobject self) {
...
jobject Java_com_yandex_contest_invoker_impl_Pipe_getOutputStream(
