...
void Java_com_yandex_contest_invoker_impl_Container_classInit(
    JNIEnv *env, jclass containerClass) {
  YANDEX_JNI_METHOD_BEGIN(env)
  containerClass_.assign(containerClass, "impl");
  filesystemId_ = containerClass_.getFieldId(
      "filesystem", "Lcom/yandex/contest/invoker/impl/Filesystem;");
  YANDEX_JNI_METHOD_END_VOID(env)
}

void Java_com_yandex_contest_invoker_impl_Container_finalize(JNIEnv *env,
                                                             jobject self) {
  YANDEX_JNI_METHOD_BEGIN_THIS(env, containerClass_, self)
  if (this_ && *this_) STREAM_ERROR << "Container was not destroyed.";
  containerClass_.finalize(self);
  YANDEX_JNI_METHOD_END_VOID(env)
}

void Java_com_yandex_contest_invoker_impl_Container_destroy(JNIEnv *env,
                                                            jobject self) {
  YANDEX_JNI_METHOD_HANDLE_DESTROY(env, containerClass_, self)
}

jboolean Java_com_yandex_contest_invoker_impl_Container_exists(JNIEnv *env,
                                                               jobject self) {
  YANDEX_JNI_METHOD_HANDLE_EXISTS(env, containerClass_, self)
}

/// Signature: ()V
void Java_com_yandex_contest_invoker_impl_Container_create__(JNIEnv *env,
                                                             jobject self) {
  YANDEX_JNI_METHOD_BEGIN(env)
...
void Java_com_yandex_contest_invoker_impl_Container_create__Lcom_yandex_contest_invoker_IContainerConfig_2(
  ...
  containerClass_.copyToPointer(
      self,
      ContainerContext::create(config::load<ContainerConfig>(containerConfig)));
  YANDEX_JNI_METHOD_END_VOID(env)
}
...
/// Signature:
/// (Lcom/yandex/contest/invoker/IContainerConfig;Lcom/yandex/contest/invoker/lxc/ILxcConfig;)V
...
void Java_com_yandex_contest_invoker_impl_Container_createFilesystem(
    JNIEnv *env, jobject self) {
  YANDEX_JNI_METHOD_BEGIN_CONTEXT_THIS(env, ctx, containerClass_, self)
  LocalRef<jobject> filesystem(
      impl::filesystem::create((*this_)->member().filesystem()));
  ctx->env()->SetObjectField(self, filesystemId_, filesystem.get());
  YANDEX_JNI_METHOD_END_VOID(env)
}

jobject Java_com_yandex_contest_invoker_impl_Container_createProcessGroup(
    JNIEnv *env, jobject self) {
  YANDEX_JNI_METHOD_BEGIN_THIS(env, containerClass_, self)
...
jobject
Java_com_yandex_contest_invoker_impl_Container_getProcessGroupDefaultSettings(
    JNIEnv *env, jobject self) {
  YANDEX_JNI_METHOD_BEGIN_THIS(env, containerClass_, self)
