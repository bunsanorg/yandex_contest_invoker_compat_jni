...
void Java_com_yandex_contest_invoker_impl_unistd_access_Id_classInit(
    JNIEnv *env, jclass idClass) {
  YANDEX_JNI_METHOD_BEGIN(env)
  idClass_.assign(idClass, "impl");
  YANDEX_JNI_METHOD_END_VOID(env)
}

void Java_com_yandex_contest_invoker_impl_unistd_access_Id_finalize(
...
void Java_com_yandex_contest_invoker_impl_unistd_access_Id_create(JNIEnv *env,
                                                                  jobject self,
                                                                  jint uid,
                                                                  jint gid) {
  YANDEX_JNI_METHOD_BEGIN(env)
...
jint Java_com_yandex_contest_invoker_impl_unistd_access_Id_getUid(
    JNIEnv *env, jobject self) {
...
jint Java_com_yandex_contest_invoker_impl_unistd_access_Id_getGid(
    JNIEnv *env, jobject self) {
  YANDEX_JNI_METHOD_BEGIN_THIS(env, idClass_, self)
  return this_->gid;
  YANDEX_JNI_METHOD_END_PRIMITIVE(env)
