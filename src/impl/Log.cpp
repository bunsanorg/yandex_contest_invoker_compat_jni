...
class JavaLog {
 public:
  ...
  void append(const boost::posix_time::ptime &timestamp, const Log::Level level,
 ...
 private:
  friend void ::Java_com_yandex_contest_invoker_impl_Log_classInit(JNIEnv *,
                                                                   jclass);
...
void Java_com_yandex_contest_invoker_impl_Log_registerInstance(JNIEnv *env,
                                                               jclass,
                                                               jobject log) {
  YANDEX_JNI_METHOD_BEGIN(env)
