...
void Java_com_yandex_contest_invoker_impl_Process_finalize(JNIEnv *env,
                                                           jobject self) {
...
void Java_com_yandex_contest_invoker_impl_Process_destroy(JNIEnv *env,
                                                          jobject self) {
  YANDEX_JNI_METHOD_HANDLE_DESTROY(env, processClass_, self);
}

jboolean Java_com_yandex_contest_invoker_impl_Process_exists(JNIEnv *env,
                                                             jobject self) {
...
jobject Java_com_yandex_contest_invoker_impl_Process_getEnvironment__(
    JNIEnv *env, jobject self) {
  YANDEX_JNI_METHOD_BEGIN_THIS(env, processClass_, self)
  return newHashMap(this_->member().environment(), newStringUTF, newStringUTF)
      .release();
  YANDEX_JNI_METHOD_END_OBJECT(env)
}
...
jstring
Java_com_yandex_contest_invoker_impl_Process_getEnvironment__Ljava_lang_String_2(
...
jobject Java_com_yandex_contest_invoker_impl_Process_getResourceLimits(
  ...
  return impl::process::resource_limits::create(
             this_->member().resourceLimits()).release();
  YANDEX_JNI_METHOD_END_OBJECT(env)
}
...
jobject Java_com_yandex_contest_invoker_impl_Process_getOwnerId(JNIEnv *env,
                                                                jobject self) {
  YANDEX_JNI_METHOD_BEGIN_THIS(env, processClass_, self)
...
void Java_com_yandex_contest_invoker_impl_Process_setOwnerId(JNIEnv *env,
                                                             jobject self,
                                                             jobject ownerId) {
  YANDEX_JNI_METHOD_BEGIN_THIS(env, processClass_, self)
...
jobject Java_com_yandex_contest_invoker_impl_Process_getResult(JNIEnv *env,
                                                               jobject self) {
  YANDEX_JNI_METHOD_BEGIN_THIS(env, processClass_, self)
...
void Java_com_yandex_contest_invoker_impl_Process_setStream(JNIEnv *env,
                                                            jobject self,
                                                            jint fd,
                                                            jobject stream) {
...
jobject Java_com_yandex_contest_invoker_impl_Process_getStream(JNIEnv *env,
                                                               jobject self,
                                                               jint fd) {
  YANDEX_JNI_METHOD_BEGIN_THIS(env, processClass_, self)
...
void Java_com_yandex_contest_invoker_impl_Process_closeStream(JNIEnv *env,
                                                              jobject self,
                                                              jint fd) {
  YANDEX_JNI_METHOD_BEGIN_THIS(env, processClass_, self)
...
jboolean Java_com_yandex_contest_invoker_impl_Process_hasStream(JNIEnv *env,
                                                                jobject self,
                                                                jint fd) {
  YANDEX_JNI_METHOD_BEGIN_THIS(env, processClass_, self)
...
jint Java_com_yandex_contest_invoker_impl_Process_id(JNIEnv *env,
                                                     jobject self) {
  YANDEX_JNI_METHOD_BEGIN_THIS(env, processClass_, self)
