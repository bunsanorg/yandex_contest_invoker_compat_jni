...
void Java_com_yandex_contest_invoker_impl_Filesystem_push(
    JNIEnv *env, jobject self, jstring local, jstring remote, jobject ownerId,
    jint mode) {
  YANDEX_JNI_METHOD_BEGIN_THIS(env, filesystemClass_, self)
...
jobject Java_com_yandex_contest_invoker_impl_Filesystem_getFileStatus(
  ...
  return impl::unistd::file_status::create(
             this_->fileStatus(getStringUTF(remote))).release();
  YANDEX_JNI_METHOD_END_OBJECT(env)
}
...
void Java_com_yandex_contest_invoker_impl_Filesystem_setOwnerId(
  ...
  YANDEX_JNI_METHOD_BEGIN_THIS(env, filesystemClass_, self)
  this_->setOwnerId(getStringUTF(remote),
                    config::load<unistd::access::Id>(ownerId));
  YANDEX_JNI_METHOD_END_VOID(env)
}

void Java_com_yandex_contest_invoker_impl_Filesystem_setMode(JNIEnv *env,
                                                             jobject self,
                                                             jstring remote,
                                                             jint mode) {
  YANDEX_JNI_METHOD_BEGIN_THIS(env, filesystemClass_, self)
...
void Java_com_yandex_contest_invoker_impl_Filesystem_pull(JNIEnv *env,
                                                          jobject self,
                                                          jstring local,
                                                          jstring remote) {
  YANDEX_JNI_METHOD_BEGIN_THIS(env, filesystemClass_, self)
