...
void Java_com_yandex_contest_invoker_impl_ProcessGroup_finalize(JNIEnv *env,
                                                                jobject self) {
...
void Java_com_yandex_contest_invoker_impl_ProcessGroup_destroy(JNIEnv *env,
                                                               jobject self) {
  YANDEX_JNI_METHOD_HANDLE_DESTROY(env, processGroupClass_, self)
}

jboolean Java_com_yandex_contest_invoker_impl_ProcessGroup_exists(
    JNIEnv *env, jobject self) {
  YANDEX_JNI_METHOD_HANDLE_EXISTS(env, processGroupClass_, self)
}

void Java_com_yandex_contest_invoker_impl_ProcessGroup_start(JNIEnv *env,
                                                             jobject self) {
...
void Java_com_yandex_contest_invoker_impl_ProcessGroup_stop(JNIEnv *env,
                                                            jobject self) {
  YANDEX_JNI_METHOD_BEGIN_THIS(env, processGroupClass_, self)
  this_->member().stop();
  YANDEX_JNI_METHOD_END_VOID(env)
...
jobject Java_com_yandex_contest_invoker_impl_ProcessGroup_synchronizedCall(
    JNIEnv *env, jobject self) {
  YANDEX_JNI_METHOD_BEGIN_THIS(env, processGroupClass_, self)
  return impl::process_group::result::create(this_->member().synchronizedCall())
      .release();
  YANDEX_JNI_METHOD_END_OBJECT(env)
}

jobject Java_com_yandex_contest_invoker_impl_ProcessGroup_poll(JNIEnv *env,
                                                               jobject self) {
  YANDEX_JNI_METHOD_BEGIN_THIS(env, processGroupClass_, self)
  boost::optional<ProcessGroup::Result> result = this_->member().poll();
  if (result) {
...
jobject Java_com_yandex_contest_invoker_impl_ProcessGroup_getResult(
    JNIEnv *env, jobject self) {
  YANDEX_JNI_METHOD_BEGIN_THIS(env, processGroupClass_, self)
  return impl::process_group::result::create(this_->member().result())
      .release();
  YANDEX_JNI_METHOD_END_OBJECT(env)
}
...
jobject Java_com_yandex_contest_invoker_impl_ProcessGroup_createProcess(
  ...
  YANDEX_JNI_METHOD_BEGIN_THIS(env, processGroupClass_, self)
  return impl::process::create(this_->context().createProcess(
                                   getStringUTF(executable))).release();
  YANDEX_JNI_METHOD_END_OBJECT(env)
}
...
jobject
Java_com_yandex_contest_invoker_impl_ProcessGroup_getProcessDefaultSettings(
    JNIEnv *env, jobject self) {
  YANDEX_JNI_METHOD_BEGIN_THIS(env, processGroupClass_, self)
  return impl::process::default_settings::create(
             this_->member().processDefaultSettings()).release();
  YANDEX_JNI_METHOD_END_OBJECT(env)
}
