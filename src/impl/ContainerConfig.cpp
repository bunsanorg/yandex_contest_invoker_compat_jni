...
void Java_com_yandex_contest_invoker_impl_ContainerConfig_finalize(
...
void Java_com_yandex_contest_invoker_impl_ContainerConfig_create(
  ...
  YANDEX_JNI_METHOD_BEGIN(env)
  containerConfigClass_.copyToPointer(
      self, config::load<ContainerConfig>(containerConfig));
  YANDEX_JNI_METHOD_END_VOID(env)
}
...
jobject
Java_com_yandex_contest_invoker_impl_ContainerConfig_getProcessGroupDefaultSettings(
    JNIEnv *env, jobject self) {
  YANDEX_JNI_METHOD_BEGIN_THIS(env, containerConfigClass_, self)
  return impl::process_group::default_settings::create(
             this_->processGroupDefaultSettings).release();
  YANDEX_JNI_METHOD_END_OBJECT(env)
}

jobject
Java_com_yandex_contest_invoker_impl_ContainerConfig_getControlProcessConfig(
    JNIEnv *env, jobject self) {
  YANDEX_JNI_METHOD_BEGIN_THIS(env, containerConfigClass_, self)
  return impl::control_process_config::create(this_->controlProcessConfig)
      .release();
  YANDEX_JNI_METHOD_END_OBJECT(env)
}

jobject
Java_com_yandex_contest_invoker_impl_ContainerConfig_getFilesystemConfig(
    JNIEnv *env, jobject self) {
  YANDEX_JNI_METHOD_BEGIN_THIS(env, containerConfigClass_, self)
...
jobject Java_com_yandex_contest_invoker_impl_ContainerConfig_fromEnvironment(
    JNIEnv *env, jclass) {
  YANDEX_JNI_METHOD_BEGIN(env)
  return impl::container_config::create(ContainerConfig::fromEnvironment())
      .release();
  YANDEX_JNI_METHOD_END_OBJECT(env)
}
